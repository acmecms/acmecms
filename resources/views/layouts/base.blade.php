...
<head>
    ...
    <link rel="stylesheet" href="{{asset('/acmecms/backend/js/layui-v2.5.5/css/layui.css')}}" media="all">
...
<script src="{{asset('/acmecms/backend/js/layui-v2.5.5/layui.js')}}" charset="utf-8"></script>
<script src="{{asset('/acmecms/js/lay-config.js')}}" charset="utf-8"></script>
<script>
    layui.use(['jquery', 'layer', 'miniAdmin', 'miniTongji'], function () {
        ...
        var options = {
            iniUrl: "acmecms/api/init.json",    // 初始化接口
            clearUrl: "acmecms/api/clear.json", // 缓存清理接口
